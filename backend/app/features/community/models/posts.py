...
# Post kinds. `text`/`question` are the originals; the rest are the Reddit-style
# flair set. Stored as a plain string (no DB enum) so this list can grow without
# a migration. `meme` is body-based for now (image upload is a follow-up).
POST_TYPES = (
    "text",
    "question",
    "discussion",
