...
from ..models.match_cut import MatchCut, MatchCutMember
from ..models.user import User
from ..services.match_cut import match_cut_recommendations, taste_match
...
async def create_cut(
    ...
    title = (body.title or "").strip()[:80] or "Untitled Cut"
